...
@section('pagetitle') Add Cash Receipt @endsection
...
@endif
        <form action="{{ route('receiving_permission.store')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <select name="account" class="form-control account select" onchange="getoperations()" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                     <div class="form-group">
                            ...
                            <input type="number" step="0.1" min=0 name="money" id="added_value" class="form-control money">
