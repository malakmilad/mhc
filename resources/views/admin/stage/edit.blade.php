        ...
        <div class="box box-info">
            <div class="box-header">
              ...
              <div class="pull-left box-tools">
                <a href="{{ route('stage.index',$menuid) }}" class="btn btn-info btn-sm">@lang('home.back') <i class="fa fa-arrow-circle-left"></i></a>
              </div><!-- /. tools -->
            </div>
            <div class="box-body">
            @if(count($errors) > 0)
              ...
              <form action="{{ route('stage.update',$Stage['id']) }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="{{ $Stage->name }}" required placeholder="@lang('home.name') ">
                </div>
