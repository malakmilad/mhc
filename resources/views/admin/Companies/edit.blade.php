            ...
            @if(count($errors) > 0)
              ...
              <form action="{{ route('Company.update',$Company['id']) }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="{{ $Company->name }}" required placeholder="@lang('home.name')">
                </div>
               <div class="form-group">
                  <lable>  Perc % </lable>
                  <input type="text" class="form-control" name="perc" value="{{ $Company->perc }}"  placeholder="perc %">
                </div>
