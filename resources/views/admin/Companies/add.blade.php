          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                ...
                <a href="{{ route('company.index',$menuid) }}" class="btn btn-info btn-sm">  @lang('home.back') <i class="fa fa-arrow-circle-left"></i></a>
              </div><!-- /. tools -->
            </div>
            <div class="box-body">
            @if(count($errors) > 0)
              ...
              <input type="hidden" name="menuid" value="{{ $menuid }}">
                ...
                <div class="form-group">
                  <lable>  Perc % </lable>
                  <input type="text" class="form-control" name="perc" value="{{ old('perc') }}"  placeholder="perc %">
                </div>
