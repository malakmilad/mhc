...
@section('pagetitle') @lang('home.Company') @endsection
@section('contentheader') 
 <section class="content-header">
	  ...
	  <!-- <ol class="breadcrumb">
	    ...
	    <li class="active">@lang('home.Company')</li>
	  </ol> -->
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"> @lang('home.Company')</h3>
                  <div class="box-tools">-->
          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h5 class="card-title">  @lang('home.Company')</h5>
                <div class="card-tools">
                    ...
                    <a href="{{ route('company.create',$menuid) }}" class="pull-right action add"> <i class="fa fa-plus"></i> Add </a>
                    @endif  
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="display table-bordered" style="width:100%">
                   ...
                   @if($allcompanies->count() > 0)
                    ...
                    <tbody>
                  @foreach($allcompanies as $act)
                    <tr>
                      <td class="text-center">{{ $i }}</td>
                      <td class="text-center">{{ $act['name'] }}</td>
                      <td class="text-center">{{ $act['perc'] }}</td>
                      
                      <td class="text-center">{{ date('d/m/Y',strtotime($act['created_at'])) }}</td>
                      <td class="text-center">
                      @if($update == "yes")
                      <a href="{{ route('company.edit',['Company' => $act['id'] , 'menuid' => $menuid ] ) }}" class="action edit"><i class="fa fa-edit"></i> </a>
                      @endif
                      @if($delete == "yes")
                      <a href="{{ route('company.destory',['Company' => $act['id'] , 'menuid' => $menuid ] ) }}" class="action delete"> <i class="fa fa-times"></i> </a>
                      @endif
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
