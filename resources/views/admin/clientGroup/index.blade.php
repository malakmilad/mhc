...
@section('contentheader') 
 <section class="content-header">
	  <h1>
	    ...
	    <small>	@lang('home.client_group_desc') </small>
	  </h1>
	  <!-- <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"> @lang('home.client_group')</h3>
                  <div class="box-tools">
                    ...
                    <a href="{{ route('client_groups.create',$menuid) }}" class="pull-right action add"> <i class="fa fa-plus"></i> Add </a>
                    @endif  
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="display table-bordered" style="width:100%" id="report">
                   ...
                   @if($allclientGroups->count() > 0)
                    ...
                    <tbody>
                  @foreach($allclientGroups as $act)
                    <tr>
                      ...
                      @if($update == "yes")
                      <a href="{{ route('client_groups.edit',['clientGroup' => $act['id'] , 'menuid' => $menuid ] ) }}" class="action edit"><i class="fa fa-pencil"></i> </a>
                      @endif
                      @if($delete == "yes")
                      <a href="{{ route('client_groups.destory',['clientGroup' => $act['id'] , 'menuid' => $menuid ] ) }}" class="action delete"> <i class="fa fa-times"></i> </a>
                      @endif
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
