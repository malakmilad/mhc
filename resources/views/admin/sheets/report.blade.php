    ...
    <div class="container-fluid h-100">
        ...
        -->
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <form action="{{ route('sheet.reportsearch') }}" id="searchrame" method="post"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if (!request()->input('dateto') && !request()->input('datefrom') && !request()->input('dydate'))
                                    <td class="text-center">{{ date('d/m/Y', strtotime($dynmicdate)) }}</td>
                                @endif
                                @if (request()->input('dynmicdate'))
                                    <td class="text-center">{{ request()->input('dynmicdate') }}</td>
                                @endif
