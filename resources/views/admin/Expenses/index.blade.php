...
@section('pagetitle') @lang('home.Expenses') @endsection
 ...
 <section class="content-header">
	 ...
	 Expenses
	  ...
	  <!-- <ol class="breadcrumb">
	    ...
	    <li class="active">@lang('home.Expenses')</li>
	  </ol> -->
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"> @lang('home.Expenses')</h3>
                  <div class="box-tools">-->
          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h5 class="card-title">  @lang('home.Expenses')</h5>
                <div class="card-tools">
                    ...
                    <a href="{{ route('expense.create',$menuid) }}" class="pull-right action add"> <i class="fa fa-plus"></i> Add </a>
                    @endif  
                ...
                <div class="box-body table-responsive">
                  ...
                  @foreach($allExpenses as $act)
                    <tr>
                      ...
                      @if($update == "yes")
                      <a href="{{ route('expense.edit',['Expenses' => $act['id'] , 'menuid' => $menuid ] ) }}" class="action edit"><i class="fa fa-edit"></i> </a>
                      @endif
                      @if($delete == "yes")
                      <a href="{{ route('expense.destory',['Expenses' => $act['id'] , 'menuid' => $menuid ] ) }}" class="action delete"> <i class="fa fa-times"></i> </a>
                      @endif
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
