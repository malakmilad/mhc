...
@section('contentheader') 
 <section class="content-header text-right">
    <h1>
      @lang('home.menus')
      <small>@lang('home.edit_menu')</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> @lang('home.control') </a></li>
      <li class="active">@lang('home.edit_menu')</li>
    </ol>
 </section>
@endsection
     ...
     <div class="col-xs-12">
        <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">@lang('home.edit_menu')</h3>
              <!-- tools box -->
            ...
            @if(count($errors) > 0)
              ...
              <form action="{{ route('menu.update',$menu['id']) }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="{{ $menu->name }}" placeholder="@lang('home.arabic_name')">
                </div>

                <div class="form-group">
                  <lable>  @lang('home.english_name') </lable> <span style="color: red;">*</span>
                 <input type="text" class="form-control" name="name_en" value="{{ $menu->name_en }}" placeholder="@lang('home.english_name')">
                </div>

                <div class="form-group">
                   <lable> @lang('home.icon') </lable> <span style="color: red;">*</span>
                  <input type="text" class="form-control" name="icon" value="{{ $menu['icon'] }}" placeholder="@lang('home.icon')">
                </div>

                <div class="form-group">
                    <lable> @lang('home.menu_url') </lable>
                  <input type="text" class="form-control" name="url" value="{{ $menu['url'] }}" placeholder="@lang('home.menu_url')">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="parent_id">
                    ...
                    @foreach($allmenus as $men)
                      ...
                      <option {{ $selected }} value="{{ $men['id'] }}">{{ $men['name'] }}</option>    
                     @else 
                     <option {{ $selected }} value="{{ $men['id'] }}">{{ $men['name_en'] }}</option>    
                     @endif
                    @endforeach
                  </select>
                </div>
