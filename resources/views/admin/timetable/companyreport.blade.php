    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-2">
            ...
            <div class="small-box bg-success">
                ...
                <a href="{{ route('timetable.companyreport', 53) }}" class="small-box-footer">More info <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
    ...
    <div class="container-fluid h-100">
        ...
        -->
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <form action="{{ route('timetable.companyreportsearch') }}" id="searchrame" method="post"
                    ...
                    <table class="table table-bordered table-hover" id="report">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                @if (request()->input('dateto'))
                                    <td class="text-caenter"> {{ request()->input('dateto') }}</td>
                                @endif
                                ...
                                @endif
                                <!--  <th class="text-center">{{ $ma3krevnue }}</th>-->
                                <th class="text-center">{{ $ma3krevnue }}</th>
                                <td class="text-center">{{ $deduct_value }}</td>
                            </tr>
