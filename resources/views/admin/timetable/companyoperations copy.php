     ...
     <br><br>
                  <table class="table table-bordered table-hover" id="report">
                   ...
                   <thead>
                    <tr>
                      ...
                      <th class="text-center"> Added Value</th> 
                      <th class="text-center"> Deduct Value</th> 
                  ...
                  @foreach($alltimetables as $cat)
                    ...
                    <tr style="background-color: {{ $cat['color']  }}">
                      ...
                      <td class="text-center">{{ $cat->added_value }}</td>
                     <td class="text-center">{{ $cat->deduct_value }}</td>
                    </tr>
