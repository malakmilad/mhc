...
@section('pagetitle') @lang('home.phone_type') @endsection
@section('contentheader') 
 <section class="content-header">
	  <h1>
      @lang('home.phone_type')
      <small>@lang('home.phone_type_desc')</small>
	  </h1>
	  <!-- <ol class="breadcrumb">
	    <li><a href="#"><i class="fa fa-dashboard"></i>  @lang('home.control') </a>
      </li>
	    <li class="active"> @lang('home.phone_type') </li>
	  </ol> -->
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">@lang('home.phone_type')</h3>
                  <div class="box-tools">-->
          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h5 class="card-title">  @lang('home.phone_type')</h5>
                <div class="card-tools">
                    ...
                    <a href="{{ route('phonetype.create',$menuid) }}" class="pull-right action add"> <i class="fa fa-plus"></i> Add </a>
                    @endif  
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="display table-bordered" style="width:100%">
                      <thead>
                   @if($allphonetypes->count() > 0)
                    <tr>
                      <th class="text-center">#</th>
                      <th class="text-center">@lang('home.phone_type')</th>
                  ...
                  @foreach($allphonetypes as $cat)
                    <tr style="background-color: {{ $cat['color']  }}">
                      ...
                      @if($update == "yes")
                      <a href="{{ route('phonetype.edit',['phonetype' => $cat['id'] , 'menuid' => $menuid ] ) }}" class="action edit"><i class="fa fa-edit"></i> </a>
                      @endif
                      @if($delete == "yes")
                      <a href="{{ route('phonetype.destory',['phonetype' => $cat['id'] , 'menuid' => $menuid ] ) }}" class="action delete"> <i class="fa fa-times"></i> </a>
                      @endif
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
