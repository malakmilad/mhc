...
@section('pagetitle') Edit Payment Receipt @endsection
...
@endif
        <form action="{{ route('giving_permission.update')}}" method="post">
                {{ csrf_field() }}
                 ...
                 <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <a href="{{ route('giving_permission.index',['menuid'=>$menuid ]) }}" class="btn btn-danger" >إلغاء</a>
