          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              ...
              <!--  <h5 class="card-title">  @lang('home.add_new')</h5>-->
               ...
               <!-- <a href="{{ route('home') }}" class="btn btn-info btn-sm">  @lang('home.back') <i class="fa fa-arrow-circle-left"></i></a>-->
              </div><!-- /. tools -->
            </div>
            <div class="box-body">
            @if(count($errors) > 0)
              ...
              <input type="hidden" name="menuid" value="{{ $menuid }}">
                ...
                <div class="row">
                   ...
                   <br>
                      ...
                      <br>
                       <span> {{$i}}</span>
                            <input type="text" class="form-control" name="{{'question_id'.$i}}" value="{{ $question->question }}" required placeholder="Question" />
                       ...
                       <!-- <span>{{$question->question}}</span>-->
                        @if($question->question_type=="True/False Question")
                         <!-- <input type="checkbox" id="answer" name="answer" value="1" >
                          ...
                          <br>
                          <input type="radio" name="{{'answer_'.$i}}" value="0"> False
                          <input type="radio" name="{{'answer_'.$i}}" value="1"> True

                        @else
                          <div class="feedback">
                            <div class="rating">
                            <input class="star star-5" id="{{'star-5'.$i}}" type="radio" value="5" name="{{'answer_'.$i}}"/>
                            <label class="star star-5" for="{{'star-5'.$i}}"></label>
                            <input class="star star-4" id="{{'star-4'.$i}}" type="radio" value="4" name="{{'answer_'.$i}}"/>
                            <label class="star star-4" for="{{'star-4'.$i}}"></label>
                            <input class="star star-3" id="{{'star-3'.$i}}" type="radio" value="3" name="{{'answer_'.$i}}"/>
                            <label class="star star-3" for="{{'star-3'.$i}}"></label>
                            <input class="star star-2" id="{{'star-2'.$i}}" type="radio" value="2" name="{{'answer_'.$i}}"/>
                            <label class="star star-2" for="{{'star-2'.$i}}"></label>
                            <input class="star star-1" id="{{'star-1'.$i}}" type="radio" value="1" name="{{'answer_'.$i}}"/>
