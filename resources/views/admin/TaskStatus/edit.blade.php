          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                ...
                <a href="{{ route('taskStatus.index',$menuid) }}" class="btn btn-info btn-sm"> @lang('home.back') <i class="fa fa-arrow-circle-left"></i></a>
              </div><!-- /. tools -->
            </div>
            <div class="box-body">
            @if(count($errors) > 0)
              ...
              <form action="{{ route('taskStatus.update',$TaskStatus['id']) }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="{{ $TaskStatus->name }}" required placeholder=" @lang('home.name')">
                </div>
