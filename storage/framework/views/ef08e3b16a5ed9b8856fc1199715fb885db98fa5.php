<?php $__env->startSection('pagetitle'); ?> <?php echo app('translator')->getFromJson('home.Company'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('contentheader'); ?> 
 <section class="content-header">
	  ...
	  <!-- <ol class="breadcrumb">
	    ...
	    <li class="active"><?php echo app('translator')->getFromJson('home.Company'); ?></li>
	  </ol> -->
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"> <?php echo app('translator')->getFromJson('home.Company'); ?></h3>
                  <div class="box-tools">-->
          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h5 class="card-title">  <?php echo app('translator')->getFromJson('home.Company'); ?></h5>
                <div class="card-tools">
                    ...
                    <a href="<?php echo e(route('company.create',$menuid)); ?>" class="pull-right action add"> <i class="fa fa-plus"></i> Add </a>
                    <?php endif; ?>  
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="display table-bordered" style="width:100%">
                   ...
                   <?php if($allcompanies->count() > 0): ?>
                    ...
                    <tbody>
                  <?php $__currentLoopData = $allcompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td class="text-center"><?php echo e($i); ?></td>
                      <td class="text-center"><?php echo e($act['name']); ?></td>
                      <td class="text-center"><?php echo e($act['perc']); ?></td>
                      
                      <td class="text-center"><?php echo e(date('d/m/Y',strtotime($act['created_at']))); ?></td>
                      <td class="text-center">
                      <?php if($update == "yes"): ?>
                      <a href="<?php echo e(route('company.edit',['Company' => $act['id'] , 'menuid' => $menuid ] )); ?>" class="action edit"><i class="fa fa-edit"></i> </a>
                      <?php endif; ?>
                      <?php if($delete == "yes"): ?>
                      <a href="<?php echo e(route('company.destory',['Company' => $act['id'] , 'menuid' => $menuid ] )); ?>" class="action delete"> <i class="fa fa-times"></i> </a>
                      <?php endif; ?>
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
