<?php $__env->startSection('pagetitle'); ?> <?php echo app('translator')->getFromJson('home.task_status'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('contentheader'); ?> 
 <section class="content-header">
	  <h1>
      <?php echo app('translator')->getFromJson('home.task_status'); ?>
	    <small> <?php echo app('translator')->getFromJson('home.task_status_desc'); ?></small>
	  </h1>
	  <!-- <ol class="breadcrumb">
	    <li><a href="#"><i class="fa fa-dashboard"></i>   <?php echo app('translator')->getFromJson('home.control'); ?> </a>
      </li>
	    <li class="active"> <?php echo app('translator')->getFromJson('home.task_status'); ?></li>
	  </ol> -->
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">  <?php echo app('translator')->getFromJson('home.task_status'); ?></h3>
                  <div class="box-tools">-->
          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h5 class="card-title">  <?php echo app('translator')->getFromJson('home.task_status'); ?></h5>
                <div class="card-tools">
                    ...
                    <a href="<?php echo e(route('taskStatus.create',$menuid)); ?>" class="pull-right action add"> <i class="fa fa-plus"></i> Add </a>
                    <?php endif; ?>  
                ...
                <div class="box-body table-responsive">
                  ...
                  <?php $__currentLoopData = $allStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td class="text-center"><?php echo e($status['id']); ?></td>

                      <td class="text-center"><?php echo e($status['name']); ?></td>
                      <td class="text-center"><?php echo e(date('d/m/Y',strtotime($status['created_at']))); ?></td>
                      <td class="text-center">
                      <?php if($update == "yes"): ?>
                      <a href="<?php echo e(route('taskStatus.edit',['TaskStatus' => $status['id'] , 'menuid' => $menuid ] )); ?>" class="action edit"><i class="fa fa-edit"></i> </a>
                      <?php endif; ?>
                      <?php if($delete == "yes"): ?>
                      <a href="<?php echo e(route('taskStatus.destory',['TaskStatus' => $status['id'] , 'menuid' => $menuid ] )); ?>" class="action delete"> <i class="fa fa-times"></i> </a>
                      <?php endif; ?>
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
