...
<!--	  <h1>
	  ...
	  <ol class="breadcrumb">
	    ...
	    <li class="active">Clients Report</li></li>
	  </ol>
 </section>
...
-->
                ...
                <form action="<?php echo e(route('sheet.reportsearch')); ?>" id="searchrame" method="post" style=" margin-top: 20px; margin-left:30px;">
                 ...
                 <div class="col-3">
                  ...
                  <div class="col-3"> 
                    <div class="form-group pull-left" style="margin-left: 5px;">
                      ...
                      <input type="date" name="dynmicdate" class="col-sm-12 form-control">
                    </div>
                  </div>
                  ...
                  <table class="table table-bordered table-hover" id="report">
                   <thead>
                    <tr>
                      ...
                      <?php if(  request()->input('datefrom')): ?>
                        <th class="text-center"> Clients From Date</th>
                      <?php endif; ?>
                      
                       <?php if(  request()->input('dateto')): ?>
                        <th class="text-center"> Client To Date</th>
                       <?php endif; ?>
                   ...
                   <tbody>
                     ...
                     <tr>
                      ...
                      <td class="text-center"><?php echo e(date('d/m/Y',strtotime($dynmicdate))); ?></td>
                    
                      <?php endif; ?>
                      <?php if( request()->input('dynmicdate')): ?>
                        <td class="text-center"><?php echo e(request()->input('dynmicdate')); ?></td>
                      <?php endif; ?>
