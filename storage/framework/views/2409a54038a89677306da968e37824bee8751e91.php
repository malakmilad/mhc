    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-2">
            ...
            <div class="small-box bg-success">
                ...
                <a href="<?php echo e(route('timetable.companyreport', 53)); ?>" class="small-box-footer">More info <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
    ...
    <div class="container-fluid h-100">
        ...
        -->
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <form action="<?php echo e(route('timetable.companyreportsearch')); ?>" id="searchrame" method="post"
