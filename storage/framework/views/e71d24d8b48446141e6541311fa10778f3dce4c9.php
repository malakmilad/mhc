...
<?php $__env->startSection('contentheader'); ?> 
 <section class="content-header">
      ...
      <?php echo app('translator')->getFromJson('home.govs_areas'); ?>
	    <small><?php echo app('translator')->getFromJson('home.govs_desc'); ?></small>
	  </h1>
	  <!-- <ol class="breadcrumb">
	    <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo app('translator')->getFromJson('home.control'); ?> </a>
      </li>
	    <li class="active"><?php echo app('translator')->getFromJson('home.govs_areas'); ?></li>
	  </ol> -->
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"> <?php echo app('translator')->getFromJson('home.govs_areas'); ?></h3>
                  <div class="box-tools">-->
          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h5 class="card-title">  <?php echo app('translator')->getFromJson('home.govs_areas'); ?></h5>
                <div class="card-tools">
                    ...
                    <a href="<?php echo e(route('area.create',$menuid)); ?>" class="pull-right action add"> <i class="fa fa-plus"></i> Add </a>
                    <?php endif; ?>  
                ...
                <div class="box-body table-responsive">
                  ...
                  <table class="display table-bordered" style="width:100%" id="report">
                   ...
                   <?php if($allareas->count() > 0): ?>
                    <tr>
                      ...
                      <th class="text-center"><?php echo app('translator')->getFromJson('home.gov'); ?></th>
                  ...
                  <?php $__currentLoopData = $allareas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td class="text-center"><?php echo e($area['arabicName']); ?></td>
                      <td class="text-center"><?php echo e($area['name']); ?></td>
                      <td class="text-center"><?php echo e($area['myparent']); ?></td>
                      <td class="text-center"><?php echo e(date('d/m/Y',strtotime($area['created_at']))); ?></td>
                      <td class="text-center">
                      <?php if($update == "yes"): ?>
                      <a href="<?php echo e(route('area.edit',['area' => $area['id'] , 'menuid' => $menuid ] )); ?>" class="action edit"><i class="fa fa-edit"></i> </a>
                      <?php endif; ?>
                      <?php if($delete == "yes"): ?>
                      <a href="<?php echo e(route('area.destory',['area' => $area['id'] , 'menuid' => $menuid ] )); ?>"  class="action delete"> <i class="fa fa-times"></i> </a>
                      <?php endif; ?>
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
