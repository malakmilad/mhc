            ...
            <div class="card card-info card-outline">
              <div class="card-header">
                ...
                <div class="box-body table-responsive no-padding">
                 ...
                 <form action="<?php echo e(route('search.sheatsearch')); ?>" id="searchrame" method="post" style="display: none; margin-top: 20px; ">
...
<div class="row">
            ...
            <br>
            <br>
                <form action="<?php echo e(route('sheet.deleteallselectedsheets')); ?>" method="POST">
                 <?php echo e(csrf_field()); ?>
                  ...
                  <table class="table table-bordered table-hover" id="report">
                   ...
                   <thead>
                    <tr>
                      ...
                      <th class="text-center"><?php echo app('translator')->getFromJson('home.tasks'); ?></th>
                  ...
                  <?php $__currentLoopData = $allsheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr style="background-color: <?php echo e($cat['color']); ?>">
                      ...
                      <td class="text-center"><?php echo e($cat['activitytype']); ?></td>
                      <td><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="<?php echo '#task'.$i?>"><?php echo app('translator')->getFromJson('home.tasks'); ?></button></td>
                      <td><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="<?php echo '#ops'.$i?>"><?php echo app('translator')->getFromJson('home.opportunity'); ?></button></td>

                      <?php if($delete == "yes"): ?>
                      <td class="text-center"> 
                      
                      <input type="checkbox" name="check<?php echo e($i); ?>" value="<?php echo e($cat['id']); ?>">
                  ...
                  <?php if($delete == "yes"): ?>
                  <button class="btn btn-danger col-sm-3 pull-left"> <?php echo app('translator')->getFromJson('home.delete_selected'); ?> </button>
                  <?php endif; ?>
                  </form>
            ...
            <div class="modal-dialog modal-xl">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Operation</h4></h4>
                </div>
                <div class="modal-body">
                   <table class="table table-bordered table-hover"  id="report">>
                    <thead>
                     <tr>
                       ...
                       <th class="text-center"> <?php echo app('translator')->getFromJson('home.task_created_by'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: <?php echo e($task['color']); ?>">
                            <th class="text-center"><?php echo e($task->id); ?></th>
