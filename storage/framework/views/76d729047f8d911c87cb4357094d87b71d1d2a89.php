<?php $__env->startSection('pagetitle'); ?> <?php echo app('translator')->getFromJson('home.groups'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('contentheader'); ?> 
 <section class="content-header">
	  <h1>
	    <?php echo app('translator')->getFromJson('home.groups'); ?>
	    <small><?php echo app('translator')->getFromJson('home.groups_desc'); ?> </small>
	  </h1>
	 <!-- <ol class="breadcrumb">
	    <li><a href="#"><i class="fa fa-dashboard"></i>  <?php echo app('translator')->getFromJson('home.control'); ?> </a>
      </li>
	    <li class="active"><?php echo app('translator')->getFromJson('home.groups'); ?></li>
	  </ol> -->
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"> <?php echo app('translator')->getFromJson('home.groups'); ?></h3>
                  <div class="box-tools">-->
          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h5 class="card-title">  <?php echo app('translator')->getFromJson('home.groups'); ?></h5>
                <div class="card-tools">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($add == "yes"): ?>
                    <a href="<?php echo e(route('group.create',$menuid)); ?>" class="pull-right action add"> <i class="fas fa-plus"></i> Add </a>
                    <?php endif; ?>  
                    </div>
                  </div>
                </div><!-- /.box-header -->
                <div class="box-body table-responsive">
                  ...
                  <table class="display table-bordered" style="width:100%">
                   ...
                   <?php if($allgroups->count() > 0): ?>
                    ...
                    <tbody>
                  <?php $__currentLoopData = $allgroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="background-color: <?php echo e($cat['color']); ?>">
                      ...
                      <?php if($update == "yes"): ?>
                      <a href="<?php echo e(route('group.edit',['group' => $cat['id'] , 'menuid' => $menuid ] )); ?>" class="action edit"><i class="far fa-edit"></i> </a>
                      <?php endif; ?>
                      <?php if($delete == "yes" && $cat->id != 1): ?>
                      <a href="<?php echo e(route('group.destory',['group' => $cat['id'] , 'menuid' => $menuid ] )); ?>" class="action delete"> <i class="fas fa-times"></i> </a>
                      <?php endif; ?>
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
