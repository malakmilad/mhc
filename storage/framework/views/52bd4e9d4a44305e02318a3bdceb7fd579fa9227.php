...
<?php $__env->startSection('contentheader'); ?> 
 <section class="content-header">
	  <h1>
	    ...
	    <small><?php echo app('translator')->getFromJson('home.client_type_desc'); ?></small>
	  </h1>
	 <!-- <ol class="breadcrumb">
	    <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo app('translator')->getFromJson('home.control'); ?> </a>
      </li>
	    <li class="active"><?php echo app('translator')->getFromJson('home.client_type'); ?></li>
	  </ol> -->
            ...
            <div class="col-xs-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo app('translator')->getFromJson('home.client_type'); ?></h3>
                  <div class="box-tools">-->
            ...
            <div class="card card-info card-outline">
              <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="<?php echo e(route('customer.create',$menuid)); ?>" class="pull-right action add"> <i class="fa fa-plus"></i> Add </a>
                    <?php endif; ?>  
                ...
                <div class="box-body table-responsive">
                  ...
                  <?php $__currentLoopData = $allCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td class="text-center"><?php echo e($customer['id']); ?></td>
                      ...
                      <?php if($update == "yes"): ?>
                      <a href="<?php echo e(route('customer.edit',['customer' => $customer['id'] , 'menuid' => $menuid ] )); ?>" class="action edit"><i class="fa fa-edit"></i> </a>
                      <?php endif; ?>
                      <?php if($delete == "yes"): ?>
                      <a href="<?php echo e(route('customer.destory',['customer' => $customer['id'] , 'menuid' => $menuid ] )); ?>" class="action delete"> <i class="fa fa-times"></i> </a>
                      <?php endif; ?>
                      </td>
                    </tr>
                    <?php $i= $i + 1;?>
