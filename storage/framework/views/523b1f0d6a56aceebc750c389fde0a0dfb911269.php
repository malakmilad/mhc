  ...
  <!-- <div class="row">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <!--  <a onclick="searchcvs()" style="font-size: 15px; font-weight: bold;margin-left: 5px;" class="btn btn-sm btn-info pull-right"><?php echo app('translator')->getFromJson('home.search'); ?> <i class="fa fa-search"></i></a>
                    ...
                    <a href="<?php echo e(route('timetable.alltimes',$menuid)); ?>" style="font-size: 15px; font-weight: bold;margin-left: 5px;" class="btn btn-sm btn-success pull-right"><?php echo app('translator')->getFromJson('home.operations'); ?> <i class="fa fa-user"></i></a>
                    ...
                    <a href="<?php echo e(route('timetable.create',$menuid)); ?>" style="font-size: 15px; font-weight: bold;display: inline;" class="btn btn-sm btn-primary pull-right">   <?php echo app('translator')->getFromJson('home.add_new'); ?> <i class="fa fa-plus"></i></a>
                    <?php endif; ?>  
     ...
     <br><br>
                  ...
                  ?>
                    ...
                    <!--  <td class="text-center"><?php echo e($cat->status_name); ?></td>
                      <td class="text-center"><?php echo e($cat->type_name); ?></td>
                      <td class="text-center"><?php echo e($cat->user['name']); ?></td>
                      <td class="text-center"><?php echo e($cat->timeid); ?></td>
                      <td class="text-center"><?php echo e($cat->refer); ?></td>
                      <td class="text-center"><?php echo e($cat->total_money); ?></td>
                      <td class="text-center"><?php echo e($cat->paid); ?></td>
                      <td class="text-center"><?php echo e($cat->total_money-$cat->paid); ?></td>   
                      <td class="text-center"><?php echo e($cat->desrved_date); ?></td>-->
                  ...
                  <?php $__currentLoopData = $operations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="background-color: <?php echo e($operation['color']); ?>">
                     ...
                     <!-- <td class="text-center"><?php echo e($operation->status_name); ?></td>
                      <td class="text-center"><?php echo e($operation->type_name); ?></td>
                      <td class="text-center"><?php echo e($operation->user['name']); ?></td>
                      <td class="text-center"><?php echo e($operation->timeid); ?></td>
                      <td class="text-center"><?php echo e($operation->refer); ?></td>
                      <td class="text-center"><?php echo e($operation->total_money); ?></td>
                      <td class="text-center"><?php echo e($operation->paid); ?></td>
                      <td class="text-center"><?php echo e($operation->total_money-$operation->paid); ?></td>
                      <td class="text-center"><?php echo e($operation->desrved_date); ?></td>-->
                      <td class="text-center">
                      <?php if(count($operations)==$count+1): ?>
                      <?php if($update == "yes"): ?>
                      <a href="<?php echo e(route('timetable.edit',['timetable' => $operation['id'] , 'menuid' => $menuid ] )); ?>" class="label label-warning">تعديل <i class="fa fa-edit"></i></a>
                      <?php endif; ?>
                      <?php if($delete == "yes"): ?>
                      <a href="<?php echo e(route('timetable.destory',['timetable' => $operation['id'] , 'menuid' => $menuid ] )); ?>" class="label label-danger">مسح <i class="fa fa-times"></i></a>
                      <?php endif; ?>
                      <?php endif; ?>
                      </td>
                    </tr>
