...
<?php $__env->startSection('pagetitle'); ?> Rate Report <?php $__env->stopSection(); ?>
...
<!--	  <h1>
	  ...
	  <ol class="breadcrumb">
	    ...
	    <li class="active">Rate Report</li></li>
	  </ol>
 </section>
          ...
          <div class="card-body">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h5 class="card-title"> Rate Report</h5></h5>
                     ...
                     <tr>
                      ...
                      <td class="text-center"><?php echo e($answer->question); ?></td>
                       ...
                       <?php else: ?>
                        ...
                        <td class="text-center"><?php echo e($answer->truefalsevalue/$answer->truefalsecount); ?></td>
                       <?php endif; ?>
                      </tr>
                    <?php $i++;?>
