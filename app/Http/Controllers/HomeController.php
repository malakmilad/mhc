...
class HomeController extends Controller
{
  ...
  public function index()
  {
    ...
    /*  if (\Auth::user()->type == 1) {
     $allsheets1 = Sheet::all();
     }
     elseif (\Auth::user()->type == 0) {
     $allsheets1 = Sheet::where('user_id', '=', \Auth::user()->id)->get();
     }*/
    ...
    return view('admin.dashboard.index', compact('allinterestes', 'allarea', 'allsheetsbyarea1', 'deosnotmeeting', 'donemeeting', 'todayshhet', 'alltodaytimetables', 'allsheets', 'alltodaysheets', 'allinterestes', 'allsheetsfilteratio', 'allinterstedpeople', 'useralltodaytimetables', 'userdonemeeting', 'userdeosnotmeeting', 'usercanceldmeeting', 'canceldmeeting'));
  }
